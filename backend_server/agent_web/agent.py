...
from .prompts.coordinator import ACADEMIC_COORDINATOR_PROMPT
from .sub_agents.academic_searcher import academic_newresearch_agent
from .sub_agents.academic_web import academic_websearch_agent
